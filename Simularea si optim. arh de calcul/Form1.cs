...
namespace Simularea_si_optim.arh_de_calcul
{
    public partial class Form1 : Form
    {
        ...
        string[] words1;
        int j = 0;
        int ticks = 0, index, PC = 0, hit = 0, mis = 0;
        ...
        private void chooseFileBtn_Click(object sender, EventArgs e)
        {
            ...
            while (!file.EndOfStream)
            {
                ...
                while (words1[i] != null)
                {
                    if (k == 1)
                    {
                        l[j].tipInstructiune = Convert.ToChar(words1[i]);
                        k++;
                    }
                    else if (k == 2)
                    {
                        l[j].pc_Curent = Convert.ToInt32(words1[i]);
                        k++;
                    }
                    else if (k == 3)
                    {
                        l[j].target = Convert.ToInt32(words1[i]);
                        k = 1;
                        j++;
                    }
                    i++;
        ...
        //    //TipCacheInstruction.Size_IC = Convert.ToDouble(SizeIC.Text);
        //    //TipCacheInstruction.Bloc_Size = Convert.ToDouble(SizeBlockIC.Text);

        //    //TipCacheData.Bloc_Size = Convert.ToDouble(this.SizeBlockDC.Text);
        ...
        //    //TipSimulare.IRmax = Convert.ToInt32(this.IRmax.Text);
        ...
        //    //            nraritmetic += l[nrinstructiuni + 1].pc_Curent - l[nrinstructiuni].pc_Curent - 1;
        //    //        }
        ...
        //    //    {
        //    //        nrBranch++;
        //    //        if (nrinstructiuni == 0) { nrtotalinstr = l[nrinstructiuni].pc_Curent; nraritmetic = 2; }
        ...
        //    //                nraritmetic += l[nrinstructiuni + 1].pc_Curent - l[nrinstructiuni].target;
        //    //            }
        //    //        }
        ...
        //    //this.nrBranch.Text = nrBranch.ToString();
        //    //this.nrStore.Text = nrStore.ToString();
        //    //this.nrLoad.Text = nrLoad.ToString();

        //    //nrtotalinstr = nrLoad + nrStore + nrBranch + nraritmetic + nrintrebranch;
        //    //nrInstructiuni.Text = nrtotalinstr.ToString();
        //    //ticks = nrtotalinstr - nrLoad + nrStore + nrBranch;
        //    //tick.Text = ticks.ToString();

        //    //int ciclu = nrtotalinstr - nrLoad - nrStore - nrBranch;

        //    //cycle.Text = ciclu.ToString();
        //    //double ir;

        //    //ir = (Convert.ToDouble(nrtotalinstr) / Convert.ToDouble(ticks));
        //    //this.issueRateFinal.Text = ir.ToString();
        ...
        {
            SizeBlockIC.Text = FR.Text;
            if (Convert.ToInt32(FR.Text) > Convert.ToInt32(IBS.Text)) IBS.Text = FR.Text;
        }

        private void SizeBlockIC_SelectedIndexChanged(object sender, EventArgs e)
        {
            IRmax.Text = FR.Text;
            if (Convert.ToInt32(FR.Text) > Convert.ToInt32(IRmax.Text)) IRmax.Text = FR.Text;
            IRmax.Enabled = false;
        }
